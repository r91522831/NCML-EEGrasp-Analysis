...
% for lift onset time
tmp_onset = behavior.info_onset_time.lft_time .* EEG.srate; % info_onset_time is in second, convert onset into frame number for EEG 2048 Hz sampling rate
...
tmp_tch = behavior.info_onset_time.tch_time .* EEG.srate; % info_onset_time is in second, convert onset into frame number for EEG 2048 Hz sampling rate
tmp_behavior = nan(n_tgr_trial, 1);
for i = 1:n_beh_trial
    % trials might be removed
